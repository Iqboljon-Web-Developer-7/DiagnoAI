...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950">
      <section className="relative bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white py-20 md:py-32 overflow-hidden dark:from-blue-950 dark:via-indigo-950 dark:to-purple-950">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 to-purple-900/90 dark:from-blue-950/90 dark:to-purple-950/90"></div>

        {/* Animated background elements */}
        <div className="absolute top-20 right-10 w-32 h-32 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full opacity-20 animate-pulse dark:from-blue-800 dark:to-cyan-800"></div>
        <div className="absolute bottom-20 left-10 w-24 h-24 bg-gradient-to-br from-indigo-400 to-purple-400 rounded-full opacity-20 animate-pulse delay-1000 dark:from-indigo-800 dark:to-purple-800"></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-gradient-to-br from-cyan-400 to-blue-400 rounded-full opacity-15 animate-pulse delay-500 dark:from-cyan-800 dark:to-blue-800"></div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            <div className="text-center">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight">
                <span className="bg-gradient-to-r from-blue-200 via-cyan-200 to-purple-200 bg-clip-text text-transparent dark:from-blue-400 dark:via-cyan-400 dark:to-purple-400">
                  {t("hero.title")}
                </span>
              </h1>
      ...
      <section id="team" className="py-20 lg:py-32 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden dark:from-slate-950 dark:to-blue-950">
        <div className="absolute top-10 right-10 w-40 h-40 bg-gradient-to-br from-blue-200 to-purple-200 rounded-full opacity-20 animate-pulse dark:from-blue-900 dark:to-purple-900"></div>
        <div className="absolute bottom-10 left-10 w-32 h-32 bg-gradient-to-br from-indigo-200 to-cyan-200 rounded-full opacity-20 animate-pulse delay-1000 dark:from-indigo-900 dark:to-cyan-900"></div>
      ...
      <section className="w-full py-16 px-4 bg-[rgb(239,247,246)] dark:bg-blue-950">
        <div className="container">
          <div className="mb-12">
            ...
            <p className="font-normal text-xl text-[#00000080] [font-family:'Rubik',Helvetica] dark:text-gray-300">
          ...
          <div className="relative">
            ...
            <div className="relative flex flex-col">
              ...
              <span className="top-[52%] sticky left-1/2 transform -translate-x-1/2 bg-[#eff7f6]  w-4 h-4 z-10 flex justify-center">
                <div className="w-[26rem] sm:w-[30rem] h-[712px] shrink-0 bg-[#eff7f6] dark:bg-blue-950 z-10"></div>
              </span>
      ...
      {/* Call to Action */}
      <section className="z-50 py-20 lg:py-32 bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white relative overflow-hidden dark:from-blue-950 dark:via-indigo-950 dark:to-purple-950">
        ...
        {/* Animated background elements */}
        <div className="absolute top-10 right-10 w-40 h-40 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full opacity-10 animate-pulse dark:from-blue-800 dark:to-cyan-800"></div>
        <div className="absolute bottom-10 left-10 w-32 h-32 bg-gradient-to-br from-indigo-400 to-purple-400 rounded-full opacity-10 animate-pulse delay-1000 dark:from-indigo-800 dark:to-purple-800"></div>
        <div className="absolute top-1/2 right-1/4 w-24 h-24 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full opacity-10 animate-pulse delay-500 dark:from-purple-800 dark:to-pink-800"></div>
