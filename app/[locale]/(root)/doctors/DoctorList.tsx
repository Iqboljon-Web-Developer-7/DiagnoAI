    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 px-4 dark:bg-gray-900">
        <div className="relative">
          <div className="w-24 h-24 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 rounded-full flex items-center justify-center mb-6">
        ...
        <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">No Doctors Found</h3>
        <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">We couldn't find any doctors matching your criteria. Try adjusting your filters or search terms.</p>
      </div>
    );
  }
