...
export default function DashboardPage() {
  ...
  const healthStats = [
    { label: "Jami tashxislar", value: diagnoses && diagnoses.length ? diagnoses.length.toString() : "0", icon: Brain, color: "blue" },
    { label: "Shifokor uchrashuvlari", value: appointments && appointments.length ? appointments.length.toString() : "0", icon: User, color: "green" },
