            ...
            >
              ...
              <div>
                <Link href="/emergency-help">
                  <Button
                    variant="outline"
                    className="w-full sm:w-auto border-white bg-transparent text-white hover:bg-[#2B6A73] hover:text-white text-sm sm:text-base  transition-all hover:border-transparent duratino-300"
                  >
