...
const loading = () => {
  return (
    <div className="fixed z-50 inset-0 min-h-screen flex flex-col items-center justify-center bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute w-48 h-48 sm:w-64 sm:h-64 rounded-full border-4 border-purple-500 opacity-30 animate-pulse"></div>
        <div className="absolute w-60 h-60 sm:w-72 sm:h-72 rounded-full border border-cyan-300 opacity-20 animate-spin"></div>
        <span className="text-center text-xl sm:text-3xl font-extrabold tracking-wide bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">
          AI Diagnosis
        </span>
      </div>
