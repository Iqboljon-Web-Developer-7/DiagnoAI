...
export async function Header() {
  ...
  return (
    <header className="bg-white/70 w-full rounded-2xl backdrop-blur-sm sticky top-0 border-b shadow-sm max-w-7xl mx-auto px-[1%] flex justify-between items-center md:h-16 z-30">
      <div className="hover:scale-105 transition-transform duration-200 animate-fade-in-down opacity-0">
